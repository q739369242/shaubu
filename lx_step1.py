...
if __name__ == "__main__":
    # ServerChan
    step = random.randint(16999, 23134)
    phone = [13076636096, 18507635065, 18023746269]
    password = ['08668699liang', '123456789liang', '123456789liang']
    for i in range(len(phone)):
        main(phone[i], password[i],step)

'''
账号3：
    邮箱：lzm3333332020@163.com
    密码：08668699liang
    支付宝：lzm3333332020@163.com
    手机：18023746269
